...
import {
  ...
  CheckCircle2, Smartphone, TrendingUp, Check, Palette,
  IndianRupee, Clock3, Wallet, ChevronDown,
} from "lucide-react"
...
const faqs = [
  {
    q: "What is ApneOrder?",
    a: "ApneOrder is a QR menu and UPI payment ordering system built specifically for Indian restaurants. Restaurant owners can set up a digital QR menu, collect UPI payments directly to their account, and manage all live orders from one dashboard — without building an app or hiring any technical staff.",
  },
  {
    q: "How does QR menu ordering work for my restaurant?",
    a: "You get a unique QR code for each table. When customers scan it with their phone camera, they see your full menu instantly — no app download needed. They browse, select items, and place their order directly. The order appears on your live kitchen dashboard immediately.",
  },
  {
    q: "How do UPI payments work with ApneOrder?",
    a: "Customers pay directly to your restaurant's UPI ID — the money goes straight to your account with zero transaction fees from ApneOrder. Payments via GPay, PhonePe, Paytm, or any UPI app are fully supported.",
  },
  {
    q: "How long does it take to set up ApneOrder?",
    a: "Most restaurants go live within 10 minutes. You add your restaurant details, upload your menu items and categories, set your UPI ID, and download your table QR codes. Our guided setup flow walks you through each step.",
  },
  {
    q: "Do customers need to download an app to use ApneOrder?",
    a: "No app download needed. Customers simply scan the QR code on their table using their phone's default camera app, and the menu opens directly in their browser. It works on any Android or iPhone — no installation required.",
  },
  {
    q: "Is ApneOrder suitable for small restaurants in India?",
    a: "Yes — ApneOrder is designed specifically for small and mid-size Indian restaurants, dhabas, cafes, and food courts. Setup requires no technical knowledge, and the pricing is built around what small restaurant owners can justify on a monthly basis.",
  },
  {
    q: "How much does ApneOrder cost?",
    a: "ApneOrder is available at ₹1,499 per month with no hidden charges. This includes unlimited tables, QR menu ordering, direct UPI payments, a live order dashboard, waiter call system, and full branding customization. There are no per-transaction fees or setup charges.",
  },
  {
    q: "Can I customize the menu and branding for my restaurant?",
    a: "Yes. You can add your restaurant name, logo, brand colours, menu categories, item descriptions, prices, and photos. The QR menu your customers see reflects your restaurant's brand. You can update the menu anytime from your dashboard — changes go live instantly.",
  },
]
...
function FAQItem({ q, a, isOpen, onToggle }: {
  ...
  return (
    <div className="border border-zinc-200 rounded-2xl overflow-hidden bg-white">
      ...
      >
        <h3 className="text-[15px] sm:text-base font-bold text-zinc-900 leading-snug">{q}</h3>
        <motion.div
        ...
        {isOpen && (
          ...
          >
            <div className="px-6 pb-5 border-t border-zinc-100">
              <p className="text-sm text-zinc-600 leading-relaxed pt-4">{a}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fbfaf7] text-zinc-950 antialiased">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-10 h-[68px] flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-[10px] bg-white border border-zinc-950/[0.08] shadow-sm overflow-hidden">
              <img src="/logo.png" alt="ApneOrder logo" className="h-8 w-8 object-contain" />
            </span>
      ...
      <main className="flex-1">
        ...
        {/* ─────────────────── HERO ─────────────────── */}
        <section className="relative overflow-hidden pt-8 pb-14 lg:pt-24 lg:pb-32" aria-label="Hero">
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
              ...
              <motion.div initial="hidden" animate="visible" variants={fadeUp(0)}>
                ...
                <div className="lg:hidden">
                  ...
                  >
                    <div className="inline-flex items-center gap-2 rounded-full bg-white/80 border border-zinc-950/[0.08] px-3 py-1.5 shadow-sm">
                      ...
                      <p className="text-[11px] text-zinc-600 font-semibold">Live table ordering</p>
                    </div>
                    <p className="text-[11px] text-zinc-500 font-semibold">No app install</p>
                  </motion.div>

                  {/* MOBILE H1 — keyword optimised */}
                  <h1 className="text-[38px] font-black tracking-tight leading-[1.0] mb-5 max-w-[340px]">
                    QR Menu & UPI Payments
                    <br />
                    <span className="text-emerald-700">for Indian Restaurants.</span>
                  </h1>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="text-[13px] font-black text-zinc-950 leading-tight">Table 4 paid order</p>
                  ...
                  <p className="text-[15px] text-zinc-600 leading-relaxed mb-6 max-w-[340px]">
                    QR menu ordering, direct UPI collection, and a live order dashboard for Indian restaurant owners — all in one place.
                  </p>

                  <Link href="/onboarding" className="block mb-4">
                    <button className="h-[54px] w-full rounded-[14px] bg-emerald-700 active:bg-emerald-800 text-white font-black text-[15px] flex items-center justify-center gap-2 shadow-[0_18px_34px_rgba(4,120,87,0.24)]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <div key={s.label} className="bg-white/80 rounded-[12px] py-3 text-center border border-zinc-950/[0.07] shadow-sm">
                ...
                <div className="hidden lg:block">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-zinc-950/[0.08] shadow-sm mb-7">
                  ...
                  {/* DESKTOP H1 — keyword optimised */}
                  <h1 className="text-[60px] font-black tracking-tight leading-[1.0] mb-6 max-w-[600px]">
                    QR Menu & UPI Payments
                    <br />
                    <span className="text-emerald-700">for Indian Restaurants.</span>
                  </h1>
                  ...
                  <p className="text-lg text-zinc-600 leading-relaxed mb-8 max-w-[480px]">
                    Scan-to-order QR menus, direct UPI collection, and real-time order management — the complete restaurant ordering system for Indian restaurant owners.
                  </p>

                  <div className="flex gap-3 mb-8">
                    <Link href="/onboarding">
                      <button className="h-12 px-7 rounded-[12px] bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-sm transition-all flex items-center gap-2 shadow-[0_14px_30px_rgba(4,120,87,0.18)]">
                        Book Setup <ArrowRight size={15} />
                      </button>
                    </Link>
                    <a href="#how-it-works">
                      <button className="h-12 px-7 rounded-[12px] border border-zinc-300 hover:border-zinc-400 bg-white/60 text-zinc-700 font-bold text-sm transition-all">
                        See How It Works
                      </button>
                    </a>
                  </div>
                  ...
                  <div className="flex items-center gap-5 flex-wrap">
                    {["No setup fee", "No app needed", "Instant UPI"].map((t) => (
              ...
              >
                ...
                <div className="relative w-[238px] sm:w-[292px] h-[486px] sm:h-[590px] bg-zinc-950 rounded-[38px] sm:rounded-[42px] shadow-[0_30px_80px_rgba(24,24,27,0.22)] border-[4px] sm:border-[5px] border-zinc-800 overflow-hidden z-10">
                  <div className="absolute top-2 left-1/2 -translate-x-1/2 w-24 h-6 bg-zinc-950 rounded-full z-20 flex items-center justify-center gap-2">
                    ...
                    <div className="px-3 py-3">
                      <div className="mb-3 flex gap-1.5 overflow-hidden">
                        {["Popular", "Coffee", "Snacks"].map((category, i) => (
                          <div key={category} className={`shrink-0 rounded-full px-2.5 py-1.5 text-[9px] font-black ${i === 0 ? "bg-emerald-600 text-white shadow-sm" : "bg-white text-zinc-500 border border-zinc-100"}`}>
                            {category}
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="mb-3 rounded-[18px] bg-white p-2.5 shadow-sm border border-zinc-100">
                        <div className="flex items-center gap-2.5">
                          <div className="grid h-10 w-10 place-items-center rounded-2xl bg-amber-50 text-[11px] font-black text-amber-700">GB</div>
                      ...
                      <div className="space-y-1.5">
                        {[
                          ...
                          <div key={item.name} className="flex items-center justify-between rounded-[15px] bg-white px-2.5 py-2.5 border border-zinc-100 shadow-[0_6px_14px_rgba(24,24,27,0.03)]">
                            ...
                            <div className="flex items-center gap-2.5">
                              ...
                              <div className={`grid h-6 min-w-6 place-items-center rounded-full px-1.5 ${item.qty ? "bg-emerald-600 text-white" : "bg-zinc-950 text-white"}`}>
                      ...
                      <div className="mt-1.5 grid grid-cols-2 gap-1.5">
                        {[
                          ...
                          <div key={item.name} className="rounded-[15px] bg-white p-2.5 border border-zinc-100 shadow-[0_6px_14px_rgba(24,24,27,0.03)]">
                ...
                <motion.div
                  ...
                  className="hidden sm:block absolute -right-6 top-16 bg-white rounded-2xl shadow-xl border border-zinc-100 p-3 w-44 z-20"
                >
        ...
        {/* ─────────────────── STATS BAR ─────────────────── */}
        <section className="bg-zinc-900 py-10 lg:py-14" aria-label="Key stats">
          <div className="max-w-7xl mx-auto px-5 lg:px-10">
        ...
        {/* ─────────────────── MONEY OUTCOME ─────────────────── */}
        <section className="relative overflow-hidden py-12 lg:py-28 bg-[#f7f5ef]" aria-label="Business outcomes">
            ...
            >
              <div className="max-w-2xl">
                ...
                <h2 className="mt-3 lg:mt-4 text-[30px] sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.04] lg:leading-[1.02] text-zinc-950">
                  Fewer delays, cleaner orders, direct UPI collection.
                </h2>
              </div>
              <p className="max-w-sm text-[14px] lg:text-base leading-relaxed text-zinc-600">
                ApneOrder is designed around the moments where Indian restaurants lose time, orders, or payment clarity.
              </p>
            </motion.div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <h3 className="mt-2 text-[16px] leading-snug sm:text-xl font-black tracking-tight text-zinc-950">{item.title}</h3>
                        <p className="mt-1.5 sm:mt-2 max-w-xl text-[13px] sm:text-sm leading-relaxed text-zinc-600">{item.desc}</p>
                      </div>
                    </motion.div>
                  )
                })}
        ...
        {/* ─────────────────── FEATURES ─────────────────── */}
        <section id="features" className="py-14 lg:py-32 overflow-hidden" aria-label="Features">
          <div className="max-w-7xl mx-auto px-5 lg:px-10">
            <motion.div
            ...
            >
              ...
              <p className="text-zinc-500 text-base max-w-[280px] leading-relaxed lg:text-right">
                From first QR scan to final UPI payment — the whole stack in one platform.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              >
                <div className="absolute -right-4 -bottom-4 text-[220px] font-black leading-none select-none pointer-events-none text-white/[0.035]">10</div>
                <div className="relative z-10">
                  ...
                  <p className="text-zinc-400 text-sm mb-9 max-w-xs leading-relaxed">
                    No developers, no agency. Guided setup for Indian restaurant owners takes less time than a cup of coffee.
                  </p>
                  <div className="space-y-3.5">
                    {[
                      ...
                      <motion.div
                        ...
                        viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.2 + i * 0.09 }}
              ...
              >
                <div className="absolute -bottom-16 -right-16 w-56 h-56 bg-emerald-500 rounded-full blur-3xl opacity-50 pointer-events-none" />
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex items-center gap-2 mb-auto">
                    <div className="w-7 h-7 rounded-lg bg-white/10 flex items-center justify-center">
                      <ShieldCheck size={14} className="text-emerald-100" />
                    </div>
                    <span className="text-[11px] font-bold text-emerald-200 uppercase tracking-widest">UPI Payments</span>
                  </div>
                  <div className="my-7">
                  ...
                  <p className="text-emerald-100/80 text-sm leading-relaxed mb-6">
                    Customers pay directly to your UPI ID. Every rupee lands in your account instantly via GPay, PhonePe, or Paytm.
                  </p>
              ...
              >
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Live Dashboard</span>
                ...
                <h3 className="text-2xl font-black text-zinc-900 leading-snug mb-6">Every order,<br />in real time.</h3>
                <div className="space-y-2">
                  {[
                    ...
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: 14 }} whileInView={{ opacity: 1, x: 0 }}
                      viewport={{ once: true }} transition={{ duration: 0.35, delay: 0.28 + i * 0.1 }}
                      className="flex items-center justify-between bg-zinc-50 rounded-xl px-3.5 py-3"
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-2 h-2 rounded-full flex-shrink-0 ${order.status === "new" ? "bg-emerald-500 animate-pulse" : order.status === "prep" ? "bg-amber-400" : "bg-zinc-300"}`} />
                        <div>
                      ...
                      <div className="flex items-center gap-2.5">
                        <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full ${order.status === "new" ? "bg-emerald-50 text-emerald-600" : order.status === "prep" ? "bg-amber-50 text-amber-600" : "bg-zinc-100 text-zinc-400"}`}>{order.label}</span>
              ...
              >
                ...
                <h3 className="text-2xl font-black text-zinc-900 leading-snug mb-2">Your menu,<br />your brand colours.</h3>
                <p className="text-zinc-500 text-sm mb-8 max-w-xs leading-relaxed">
                  Every customer sees your brand on the QR menu. One click to change it anytime.
                </p>
                  ...
                  <div className="flex items-center gap-2.5">
                    {[
                      ...
                      <motion.div
                        ...
                        className={`w-9 h-9 rounded-xl shadow-sm cursor-pointer hover:scale-110 transition-transform duration-150 ${ring ? "ring-2 ring-offset-2 ring-zinc-800" : ""}`}
          ...
          <div className="max-w-7xl mx-auto px-5 lg:px-10">
            ...
            >
              ...
              <p className="text-zinc-500 text-base max-w-md mx-auto">
                Set up your restaurant&apos;s QR menu ordering system in minutes — no technical skills needed.
              </p>
            </motion.div>

            <div className="relative max-w-5xl mx-auto">
              <svg className="pointer-events-none absolute left-[16.6%] right-[16.6%] top-4 hidden h-12 w-[66.8%] md:block" viewBox="0 0 720 48" fill="none" aria-hidden="true">
                <path d="M8 24 H712" stroke="#e4e4e7" strokeWidth="2" strokeLinecap="round" />
                <motion.path d="M8 24 H712" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeDasharray="54 650"
                  animate={{ strokeDashoffset: [704, 0] }} transition={{ duration: 3.2, repeat: Infinity, ease: "linear" }} />
              </svg>

              <div className="absolute left-[29px] top-14 bottom-28 w-px bg-zinc-200 md:hidden" />
              <motion.div className="absolute left-[29px] top-14 h-16 w-px bg-gradient-to-b from-transparent via-emerald-500 to-transparent md:hidden"
                animate={{ y: [0, 230, 0] }} transition={{ duration: 3.2, repeat: Infinity, ease: "linear" }} />

              <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-10">
                {[
                  {
                    step: "01", icon: <QrCode size={22} className="text-zinc-900" />,
                    title: "Set Up Your Restaurant",
                    desc: "Add your restaurant details, upload your menu categories and items, and set your UPI ID for direct payment collection.",
                  },
                  {
                    step: "02", icon: <Smartphone size={22} className="text-zinc-900" />,
                    title: "Print & Place QR Codes",
                    desc: "Download QR codes for each table. Print and place them — no app needed for your customers to scan and order.",
                  },
                  {
                    step: "03", icon: <TrendingUp size={22} className="text-zinc-900" />,
                    title: "Watch Orders Roll In",
                    desc: "Customers scan the QR code, browse your menu, and pay directly to your UPI. Track every live order from your dashboard.",
                  },
                ].map((s, i) => (
                  <motion.div
                    key={s.step}
                    initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }} transition={{ duration: 0.45, delay: i * 0.15 }}
                  ...
                  >
                    <div className="relative w-14 h-14 md:w-20 md:h-20 bg-white rounded-2xl md:rounded-3xl border border-zinc-200 shadow-[0_12px_28px_rgba(24,24,27,0.06)] flex items-center justify-center flex-shrink-0 md:mb-5">
                      ...
                      {s.icon}
                      <div className="absolute -top-2 -right-2 w-6 h-6 md:w-7 md:h-7 bg-zinc-900 rounded-full flex items-center justify-center shadow-sm">
            ...
            >
              <Link href="/onboarding">
                <button className="h-12 px-7 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-white font-bold text-sm transition-all flex items-center gap-2 mx-auto shadow-sm">
          ...
          <div className="max-w-7xl mx-auto px-5 lg:px-10">
            ...
            >
              ...
              <p className="text-zinc-500 text-lg max-w-md mx-auto">
                One plan for Indian restaurants that want QR ordering, direct UPI payments, and live order management.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative">
                <div className="flex flex-col gap-4">
                  <div>
                    <p className="text-xs font-black uppercase tracking-[0.22em] text-emerald-400">Standard Plan</p>
                    <div className="mt-4 flex items-baseline gap-1.5">
                      <span className="text-5xl font-black tracking-tight text-white">₹1,499</span>
                      <span className="text-sm text-zinc-400">/month</span>
                    </div>
                    <p className="mt-3 text-sm text-zinc-400">
                      Everything needed to run QR menu ordering for one restaurant. No hidden charges.
                    </p>
                  </div>
        ...
        {/* ─────────────────── FAQ ─────────────────── */}
        <section id="faq" className="py-14 lg:py-32 bg-zinc-50 border-t border-zinc-100">
          <div className="max-w-3xl mx-auto px-5 lg:px-10">
            <motion.div
              initial="hidden" whileInView="visible" viewport={{ once: true }}
              variants={fadeUp(0)} className="text-center mb-10 lg:mb-14"
            >
              <span className="text-[11px] font-bold text-emerald-600 uppercase tracking-widest">FAQ</span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight mt-3 mb-4">
                Frequently Asked Questions
              </h2>
              <p className="text-zinc-500 text-base max-w-md mx-auto">
                Everything restaurant owners ask before going live with ApneOrder.
              </p>
            </motion.div>
            ...
            >
              <p className="text-sm text-zinc-500">
                ...
                <a href="mailto:support@apneorder.com" className="text-emerald-700 font-semibold hover:underline">
                  Contact our team
                </a>
              </p>
            </motion.div>
        ...
        <section className="relative overflow-hidden bg-zinc-900 py-14 lg:py-32">
          <div className="absolute inset-0 -z-0 pointer-events-none">
            <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-emerald-900/40 rounded-full blur-[90px]" />
          </div>
          ...
          >
            ...
            <Link href="/onboarding">
              <button className="h-14 px-10 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-white font-black text-lg transition-all shadow-2xl shadow-emerald-950/60 flex items-center gap-3 mx-auto">
      ...
      <footer className="bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-5 lg:px-10 py-10">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
            <div className="flex flex-col items-center md:items-start gap-3">
              ...
              <p className="text-xs text-zinc-600 text-center md:text-left max-w-[220px]">
                QR menu ordering and UPI payment system for Indian restaurants.
              </p>
            </div>

            <div className="flex flex-col items-center md:items-end gap-4">
              <div className="flex items-center gap-5">
                <Link href="/terms" className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors">Terms &amp; Conditions</Link>
                <span className="text-zinc-800 text-xs">·</span>
                <Link href="/privacy" className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors">Privacy Policy</Link>
              </div>
              <div className="flex items-center gap-3">
                <a href="https://instagram.com/apneorder" target="_blank" rel="noopener noreferrer" aria-label="ApneOrder on Instagram"
                ...
                <a href="https://twitter.com/apneorder" target="_blank" rel="noopener noreferrer" aria-label="ApneOrder on X (Twitter)"
                  className="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-zinc-200 hover:border-zinc-600 transition-all">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://linkedin.com/company/apneorder" target="_blank" rel="noopener noreferrer" aria-label="ApneOrder on LinkedIn"
                  className="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-zinc-200 hover:border-zinc-600 transition-all">
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="mt-8 pt-6 border-t border-zinc-900 text-center">
            <p className="text-xs text-zinc-700">© {new Date().getFullYear()} ApneOrder. All rights reserved.</p>
          </div>
        </div>
      </footer>
